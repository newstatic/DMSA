...
│  │    方向: 本地→外置  |  符号链接: ✓  |  上次: 5分钟前       │  │
│  ├──────────────────────────────────────────────────────────┤  │
│  │  ☑ ~/Documents  ↔  BACKUP/Documents                      │  │
│  │    方向: 双向同步  |  符号链接: ✗  |  上次: 1小时前        │  │
│  ├──────────────────────────────────────────────────────────┤  │
│  │  ☐ ~/Pictures   →  PORTABLE/Pictures (硬盘未连接)        │  │
│  │    方向: 本地→外置  |  符号链接: ✓  |  上次: 从未          │  │
│  └──────────────────────────────────────────────────────────┘  │
│                                                                 │
│  ─────────────────────────────────────────────                 │
...
│  ─────────────────────────────────────────────                 │
│                                                                 │
│  缓存位置: ~/Library/Application Support/DMSA/LocalCache/       │
│            [打开文件夹]                                         │
│                                                                 │
│  当前使用: ████████░░░░░░░░░░░░  3.2 GB / 10 GB (32%)           │
│                                                                 │
│  最大缓存: [10    ] GB                                          │
│  预留空间: [500   ] MB (淘汰后保留的缓冲空间)                     │
│                                                                 │
│  淘汰策略                                                       │
│  ─────────────────────────────────────────────                 │
│  ○ 按修改时间 (推荐) - 优先淘汰最久未修改的文件                   │
│  ○ 按访问时间 - 优先淘汰最久未访问的文件                         │
│  ○ 按文件大小 - 优先淘汰大文件                                   │
│                                                                 │
│  □ 启用自动淘汰                                                 │
...
│  ─────────────────────────────────────────────────────────────────  │
│                                                                      │
│  DMSA 帮助您自动同步本地目录与外置硬盘，让您的数据随时可用。          │
│                                                                      │
│  主要功能:                                                           │
│    ✓ 插入硬盘自动同步                                                │
│    ✓ 支持多个硬盘和目录                                              │
...
│                                                                      │
│    硬盘: BACKUP                                                      │
│    同步目录: Downloads → BACKUP/Downloads                           │
│    自动同步: ✓ 已启用                                                │
│    符号链接: ✓ 已启用                                                │
│                                                                      │
│  ─────────────────────────────────────────────────────────────────  │
